...
| 2026-08-16 | `text-body-md` → `text-body-sm` (16px → 14px) ทั้ง `Breadcrumb` และ `BreadcrumbRoot` | เส้นทางเดินเป็นข้อมูลรอง แต่ 16px = ขนาดเดียวกับเนื้อหาหลัก · ยังไม่ลงไปถึง 12px ที่แอปเดิมใช้ ⇒ **ทุกแอปที่ใช้ DS อยู่จะเห็นแถบนี้เล็กลงหนึ่งขั้นพร้อมกัน** (Portal · MediHR · Mediwork) · ความสูงของแถบลดจาก 24px เหลือ 20px ⇒ หน้าที่คำนวณความสูงคงที่ไว้ (Mediwork `pageLayout.ts`) ต้องวัดใหม่ |

---

## ยังไม่ได้ทำ

- ยังไม่เคยวัดทรงทั้งตัว (ระยะ · ขนาดไอคอน) กับแอปจริง — ขนาดตัวอักษรลงมาที่ `text-body-sm` (14px)
  แล้ว ส่วนของจริงใช้ **12px** ทั้ง Portal และ Medimatch ⇒ ยังต่างกันอยู่หนึ่งขั้น
