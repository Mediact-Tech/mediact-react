...
declare function radioDotClasses(size?: ToggleSize): string;
/**
...
type RadioControlProps = Omit<React.ComponentProps<typeof RadixRadio.Item>, "asChild" | "children"> & {
 ...
 */
declare const RadioControl: React.ForwardRefExoticComponent<Omit<RadioControlProps, "ref"> & React.RefAttributes<HTMLButtonElement>>;
 ...
 */
declare const RadioGroupRoot: React.ForwardRefExoticComponent<RadixRadio.RadioGroupProps & React.RefAttributes<HTMLDivElement>>;
...
declare function TimePicker({ id, label, hint, error, required, hideLabel, reserveMessageSpace, alwaysFloatLabel, value, defaultValue, onChange, minuteStep, step, minTime, maxTime, ampm, disabled, size, labels, className, containerClassName, }: TimePickerProps): React.JSX.Element;
...
type ProgressBarProps = Omit<React.ComponentProps<"div">, "role"> & VariantProps<typeof trackVariants> & VariantProps<typeof fillVariants> & {
