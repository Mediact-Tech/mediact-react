...
declare function FieldSkeleton({ size, shape, ...shellProps }: FieldSkeletonProps): React.JSX.Element;
/**
...
declare function TimePicker({ id, label, hint, error, required, hideLabel, alwaysFloatLabel, value, defaultValue, onChange, minuteStep, step, minTime, maxTime, ampm, disabled, size, className, containerClassName, }: TimePickerProps): React.JSX.Element;
...
declare function Stepper({ steps, current, orientation, className, onStepClick, }: StepperProps): React.JSX.Element;
...
declare function ConfirmDialog({ open, onOpenChange, title, description, tone, icon, divider, confirmLabel, cancelLabel, onConfirm, onCancel, size, isLoading, loading: loadingProp, dismissible, align, errorMessage, showCancel, children, }: ConfirmDialogProps): React.JSX.Element;
